...
namespace RealEstateRegalSpace.Models
{
    public class Common
    {
        ...
        {
            public static string CompanyName = "RealEstateRegalSpace";
            ...
            public static string Website = "RealEstateRegalSpace.com";
            public static string EmailID = "info@RealEstateRegalSpace.com";
        }
