                    ...
                    if (ds != null && ds.Tables.Count > 0)
                    {
                        if (ds.Tables[0].Rows[0]["Msg"].ToString() == "1")
                        {
                            ...
                            if (Request["chksendmsg"] == "on")
                            {
                                try
                                {
                                    string msg = "DEAR CUSTOMER,CONGRATULATION, YOU HAVE BOOKED A PLOT IN " + ds.Tables[0].Rows[0]["SiteName"].ToString() + " with plot no " + plot + ", WE ARE PLEASED TO WELCOME YOU IN Regal Space Infratech Pvt. Ltd.. BEST REGARDS TEAM Regal Space Infratech Pvt. Ltd..Thankyou";
        ...
        public ActionResult RejectPendingPayment(string id)
        {
            ...
            if (ds != null && ds.Tables[0].Rows.Count > 0)
            {
                ...
                if (ds.Tables[0].Rows[0]["MSG"].ToString() == "1")
                {
                    try
                    {
                        string msg = "YOUR CHEQUE OF RS " + ds.Tables[0].Rows[0]["PaidAmount"].ToString() + "IS BOUNCE BY THE BANK PLEASE CONTACT Regal Space Infratech Pvt. Ltd.. Kindly login" + SoftwareDetails.Website + " Thankyou";
