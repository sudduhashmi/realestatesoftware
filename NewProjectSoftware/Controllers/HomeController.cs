    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult Registration(Registration obj)
        {
            ...
            if (ds != null)
            {
                if (ds.Tables[0].Rows[0]["Msg"].ToString() == "1")
                {
                    ...
                    string msg = "Dear " + Session["AssociateName"].ToString() + " Welcome to SHASHIKALA INFRATECH.Your Login Id " + Session["AssociateLoginId"].ToString() + " and Password is " + Session["Password"].ToString() + ". Kindly login www.gayatrinfra.com Thankyou";
        ...
        public ActionResult GetPassword(string LoginId)
        {
            ...
            if (ds != null)
            {
                if (ds.Tables[0].Rows[0]["Msg"].ToString() == "1")
                {
                   string msg = "Dear " + ds.Tables[0].Rows[0]["Name"].ToString() + " Your Password is " +Crypto.Decrypt(ds.Tables[0].Rows[0]["Password"].ToString()) + " Kindly login www.ShashikalaInfratech.com Thankyou";
